...
![ВСТАВИТЬ ФОТО СО СТАНЦИЕЙ](imgs/photo1.png)
...
В комнате в общежитии одна часть проживающих при закрытом окне
может жаловаться на духоту, а другая - при открытом окне - на холод.
Знание настоящей температуры и уровня углекислого газа, а также
то, как они изменялись за последние сутки, может помочь договориться.
...
![alt text](imgs/interface_scheme1.png)

![alt text](imgs/interface_scheme2.png)
...
![alt text](imgs/scheme_first.png)
...
![alt text](imgs/interface_scheme2_final.png)
